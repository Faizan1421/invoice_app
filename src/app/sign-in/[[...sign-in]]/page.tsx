...
export default function SignInPage() {
  return (
    <Container className='min-h-[calc(100vh-100px)] flex justify-end items-center'>
      <div className="grid w-full flex-grow items-center bg-white dark:bg-[#020817] px-4 sm:justify-center">
        <SignIn.Root>
          <SignIn.Step
            name="start"
          ...
          >
            <header className="text-center">
              ...
              <h1 className="mt-4 text-xl font-medium tracking-tight text-neutral-950 dark:text-white">
            ...
            <Clerk.Field name="identifier">
              ...
              <Clerk.Input
                ...
                required
                placeholder="Email"
                className="w-full rounded-md border-b border-neutral-200 bg-white  p-[5px] text-sm/6 text-neutral-950 outline-none placeholder:text-neutral-400 "
              />
